...
class App extends Component {
  ...
  handleSendImage = (content) => {
    console.log("image")
    // this.ws.send(JSON.stringify({content: content, type: "postImage"}));
  }
  ...
  render() {
    ...
    return (
      <section>
        ...
        <Chatbar user={this.state.currentUser} onSendMessage={this.handleSendMesssage} onSendImage={this.handleSendImage} onChangeUser={this.handleChangeUser}/>
      </section>
    );
  }
}
